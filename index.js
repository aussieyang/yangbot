...
bot.listen(/Pun/i, function (message) {
  message.reply(bot.random("Do you Node what it's like not being able to Express myself?",
  "The programmer quit his job because he didn't get arrays.",
  'I switched from Perl to Ruby because I like gems.',
  "Celebrate! var hiphip = []",
  "To really understand recursion, first you must understand recursion.",
  'Why is Jesus a better programmer than Satan? Because Jesus saves.',
  "Two bytes meet.'Are you ill?' says one. 'No I'm not,' replies the other, 'I'm just a bit off.'"));
});
